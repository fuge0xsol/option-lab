...
wrangler pages deploy . --project-name=option-lab --branch=main --commit-dirty=true

echo "完成: https://fuge0xsol.github.io/option-lab/ (Actions 构建约 1 分钟)  |  https://option-lab.pages.dev"
